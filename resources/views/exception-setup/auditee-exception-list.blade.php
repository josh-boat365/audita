                            ...
                            <td>
                                <div class="d-flex gap-3">
                                    ...
                                    <form action="{{ route('exception.supervisor.action') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="batchExceptionId" value="{{ $exception['id'] }}">
                                        <input type="hidden" name="status" value="ANALYSIS">
                                        <button type="submit" class="badge round bg-dark font-size-13"><i
                                                class="bx bx-analyse"></i> Push for Resolved</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
